...
namespace TaskAuthenticationAuthorization.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            bool isAuthenticatedWithBuyerRole = User.IsInRole("buyer");
            ViewBag.IsBuyer = isAuthenticatedWithBuyerRole;
            
            var currentUser = await _context.Users
                .Include(u => u.Customer)
                .FirstOrDefaultAsync(u => u.Email == User.Identity.Name);
            
            if (isAuthenticatedWithBuyerRole)
                return View(await shoppingContext.Where(o => o.CustomerId == currentUser.Customer.Id).ToListAsync());
            if (User.IsInRole("admin"))
                return View(await shoppingContext.ToListAsync());

            return View(Array.Empty<Order>());
        }
